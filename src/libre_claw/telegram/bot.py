...
class TelegramBot:
    ...
    async def run(self) -> None:
        ...
        application.add_handler(CommandHandler("restart", handlers.new))
        ...
        application.add_handler(CommandHandler("btw", handlers.btw))
        ...
        application.add_handler(CommandHandler("skills", handlers.skills))
